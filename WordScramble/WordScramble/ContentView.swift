...
struct ContentView: View {
        ...
        NavigationView {
            ZStack {
                ...
                VStack {
                    ...
                    Spacer()
                    Text("Your score: \(String(wordScore))")
                        .padding()
                }
    ...
    func addNewWord() {
        ...
        guard isSame(word: answer) else {
            wordError(title: "Cant use the same word", message: "Really? Not as clever as you thought!")
            return
        }
        ...
        guard isReal(word: answer) else {
            wordError(title: "invalid word", message: "That isn't a real word!")
            return
        }
